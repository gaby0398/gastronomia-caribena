...
class Plantas
{
    ...
    public function create(Request $request, Response $response, $args)
    {
        ...
        if ($nombre_planta == null || $descripcion_planta == null || $imagen == null || $usuario_id == null) {
            //var_dump();
        ...
        try {
            ...
            $query = $con->prepare('CALL crear_planta(:nombre_planta, :descripcion_planta, :imagen, :usuario_id, :fecha_creacion, :fecha_actualizacion)');
